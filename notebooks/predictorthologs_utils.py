...
def read_diamond_blastp_output(filename, read_is_uniprot=False, sketch_id_in_basename=False):
...
def read_kmer_csv(csv, gene_name_tag='GN', cell_barcode_channel_pattern=CELL_BARCODE_CHANNEL_PATTERN):
